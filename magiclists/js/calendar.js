...
export const Calendar = {
    ...
    render() {
        ...
        const viewButtons = `
            <div class="calendar-view-buttons">
                <button class="btn ${this.currentView === 'month' ? 'active' : ''}" data-view="month">Month</button>
                <button class="btn ${this.currentView === 'year' ? 'active' : ''}" data-view="year">Year</button>
                <button class="btn ${this.currentView === 'day' ? 'active' : ''}" data-view="day">Day</button>
                <button class="btn" id="calendar-inline-close">✕ Close</button>
            </div>
        `;
        ...
        this.mountZone.innerHTML = `
            <div class="toolbar toolbar--spread calendar-toolbar">
                <div class="calendar-nav">
                    <button class="btn" id="calendar-prev">◀</button>
                    <span id="calendar-title" class="calendar-title">${this.getTitle()}</span>
                    <button class="btn" id="calendar-next">▶</button>
                    <select id="holiday-country-select" class="btn calendar-holiday-select">
            ...
            <div class="toolbar toolbar--spread calendar-footer">
                <button class="btn" id="calendar-today">Today</button>
                <button class="btn" id="calendar-add-note">+ Add Note</button>
            </div>
        `;
        ...
        document.getElementById('calendar-inline-close').addEventListener('click', () => this.close());
    ...
    showEventsList(events, date) {
        ...
        modal.innerHTML = `
            ...
            <button class="btn" id="close-notes-list">Close</button>
        `;
