    ...
    renderControlBar() {
        ...
        if (filterControls) {
            filterControls.innerHTML = `
                <button class="btn btn--compact ${mode === 'list' ? 'active' : ''}" id="btn-view-list">List</button>
                <button class="btn btn--compact ${mode === 'columns' ? 'active' : ''}" id="btn-view-cols">Cols</button>
                <button class="btn btn--compact ${mode === 'freeform' ? 'active' : ''}" id="btn-view-free">Free</button>
            `;
