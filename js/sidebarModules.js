...
export const SIDEBAR_MODULES = [
    ...
    { id: 'quick-actions', rootId: 'sidebar-quick-actions', headerId: 'quick-actions-header', sectionId: 'quick-actions-section', startCollapsed: true, expandOnUndock: true, collapseIgnoreExtra: '.quick-actions-header-icons, .quick-action-btn, [data-action]' },
    ...
    { id: 'tools', rootId: 'sidebar-tools', headerId: 'tools-section-header', sectionId: 'tools-section', startCollapsed: true, expandOnUndock: true, collapseIgnoreExtra: '.tools-header-icons, .tool-btn, .tools-manager-btn' },
